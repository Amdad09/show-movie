export const data = [
    ...
    },
    {
        ...
        description:
            'Batman is a DC Comics superhero created by Bob Kane and Bill Finger. He first appeared in Detective Comics #27 in 1939 and fights crime in Gotham City.',
        genr: 'Action',
        rating: 5,
        price: 899,
    },
    {
        id: crypto.randomUUID(),
        cover: 'parasite.jpg',
        title: 'Avengers: Endgame Saga',
        description:
            'Avengers is a team of superheroes from Marvel Comics including Iron Man, Captain America, Thor and others, fighting global threats together.',
        genr: 'Adventure',
        rating: 4,
        price: 999,
    },
